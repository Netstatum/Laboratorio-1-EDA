...
/** Función apuestaG
	Es la funcion general de apuestas, se asumen las siguientes cosas:
		...
		Sup1) La cantidad apostada es igual o mayor a la apuesta maxima (apuesta>=mesaJugando.apuesta_maxima)
...
/** Realizara las diferentes apuestas
	...
	Para igualar la apostando(jugador,mesaJugando.apuesta_maxima);
	Para aumentar la apostando(jugador,mesaJugando.puesta_maxima+aumento);;
